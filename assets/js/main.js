...
/*==============================
    ...
    1. Including Jquery
    2. Including MobyJs
    3. Including owl carousel
    4. Including wow.js
    5. Including Masonry
    6. Including images loaded plugin
    7. Including jquery lazy-loading plugin
    8. Including lightbox.js
    9. Including lightslider.js
    10. Including jquery.keyframes.js
    11. Including colorbox
    12. Including slick slider
    13. Including typedjs
    14. Functions & initial code
===============================*/
...
$(window).on('load', function() {
    /* =====================================
        Preloader loading         
    /* =====================================*/
    // simulate loading processm just only for html
    ...
    // Start General fade in effect for content
    (function() {
        var elements;
        var windowHeight;
    ...
    // End General fade in effect for content
});

$(window).on('resize', function () {
    // init countTrueViewPort
    countTrueViewPort();
...
$(document).ready(function () {
    ...
    if($('.typed').length && $('#typed-strings').length) {
        var typed = new Typed('.typed', {
            ...
            //strings: ['N-Connecta', 'X-Trail', 'Leaf 2020'],
     ...
     * @param forms
     */
    function toggleDisableFormButton(forms) {
    ...
    $(".add-new-testimonial-btn").colorbox({
        inline: true, 
        width: '90%',
        maxWidth: '430px',
    });
    ...
    function setModelParams() {
        ...
        // create parms string
        url += '/model-single.html?wheels=' + wheelSize + '&color=' + carColor + '&engine=' + carEngineType;
    ...
    // Adwantages box change active item
    ...
    function hideTabContent(a, element) {
    ...
    function showTabContent(b, element) {
    ...
    if(
        ...
        var modelViewverTabsParent = document.querySelector('.model-viever-tabs-list'),
            ...
            modelVieverTabsContent = document.querySelectorAll('.model-viever-tab--content');
    ...
    $('.project-accordion li:nth-child(4) .inner').toggleClass('show').slideToggle(350);
    ...
    var membersSlider = $(".members-slider"),
        ...
        membersSliderOptions = {
            ...
            navigation: false,
            mouseDrag: false,
            autoplay: false, // customer can enable of disable autoplay, default enable
    ...
    function checkClasses(){
        ...
        $('.members-slider .owl-stage .owl-item').removeClass('firstActiveItem lastActiveItem');
    ...
    $('.video-source').colorbox({
        ...
        href: function () {
            ...
            if (videoId && videoId[1]) {
                return 'http://youtube.com/embed/' + videoId[1] + '?autoplay=1';
            }
        }
    });
    ...
    var mobyMenu = new Moby({
        menu       : $('.main-menu-2'), // The menu that will be cloned
        mobyTrigger: $('#hamburger'), // Button that will trigger the Moby menu to open
        menuClass		 : 'left-side',
    ...
    // switcher for active class in main menu item,
    // check what is page and add class active to specific menu item
    switch ($('body > main').attr('id')) {
        case 'contact-page':
            $('#main-menu li a:contains("Contact Us")').addClass('active');
            break;
        case 'about-page':
            $('#main-menu li a:contains("About")').addClass('active');
            break;
        case 'models-page':
            $('#main-menu li a:contains("Models")').addClass('active');
            break;
        case 'model-single-page':
            $('#main-menu li a:contains("Models")').addClass('active');
            break;
        case 'blog-page':
            $('#main-menu li a:contains("Blog")').addClass('active');
            break;
        case 'blog-single-left':
            $('#main-menu li a:contains("Blog")').addClass('active');
            break;
        case 'blog-single-right':
            $('#main-menu li a:contains("Blog")').addClass('active');
            break;
        case 'blog-single-without-sidebar':
            $('#main-menu li a:contains("Blog")').addClass('active');
            break;
        case 'gallery-page':
            $('#main-menu li a:contains("Blog")').addClass('active');
        ...
        case 'elememts-page':
            ...
            break;
        default:
            $('#main-menu li a:contains("Home")').addClass('active');
    }
    ...
    // init travel category carousel
    $('#travel-category-carousel').owlCarousel({
        loop: false,
        nav: true,
        dots: false,
        items: 3,
        margin: 30,
        navText: [
            '<img src="./assets/i/angle-left-icn.png" alt="">',
            '<img src="./assets/i/angle-right-icn.png" alt="">'
        ],
        responsive:{
            0:{
                items: 1,
    ...
    if($('.post-gallery-slider').length) {
        //add class owl-carousel owl-theme to this class
        $('.post-gallery-slider').addClass('owl-carousel owl-theme');

        // wrap gallery item add water mark for gallery img
        $('.post-gallery-slider img').wrap( "<div class='item-wrap'></div>" );
        $('<div class="thumb-mark"><img src="./assets/i/dark-logo-icn.png" alt="Gorgan Image Gallery" title="Gorgan Image Gallery"></div>').insertAfter('.post-gallery-slider img');
    ...
    /**
     * Slow scroll to document node
     * @param node
     * @returns {boolean}
     */
    function  slowScroll(node) {
        var offset = $('.header-top-line').outerHeight(); // height of fixed header
        offset += 15;

        $('html, body').animate({
            scrollTop: $(node).offset().top - (offset + 10)
        }, 500);
     ...
     * @param elementId
     */
    function containerToContainerFluid(elementId) {
