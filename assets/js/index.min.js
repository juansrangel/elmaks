...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var wow_js_dist_wow_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! wow.js/dist/wow.js */ "./node_modules/wow.js/dist/wow.js");
/* harmony import */ var wow_js_dist_wow_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(wow_js_dist_wow_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _modules_utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/utilities */ "./src/assets/js/modules/utilities.js");
...
$(window).on("load", function () {
  ...
  }, 500); // Add class fade to each of sidebar widget

  $(".sidebar-widget").each(function (key, el) {
    $(el).addClass("fade-effect");
  }); // General fade in effect for content

  Object(_modules_utilities__WEBPACK_IMPORTED_MODULE_1__["fadeEffectForContent"])();
});
/* =====================================
    WINDOW ON SCROLL
/* =====================================*/
...
$(document).on("ready", function () {
  ...
  Object(_modules_utilities__WEBPACK_IMPORTED_MODULE_1__["toggleDisableFormButton"])(["#test-drive-inner .test-drive-form", "#call-now-inner .call-now-form","#concentimiento-inner .concentimiento-form"]); // Scroll to top
  ...
  if ($(".model-builder-widget .model-image").length) {
    ...
    Object(_modules_utilities__WEBPACK_IMPORTED_MODULE_1__["setModelParams"])();
  ...
  Object(_modules_utilities__WEBPACK_IMPORTED_MODULE_1__["animationsForComments"])(".comment"); // Wrap all tables with class table in post-content for mobile responsive

  $(".post-content .table").wrap('<div class="table-responsive"></div>'); // Start close alert messages

  Object(_modules_utilities__WEBPACK_IMPORTED_MODULE_1__["closeAlertMessages"])(); //init wow.js

  new wow_js_dist_wow_js__WEBPACK_IMPORTED_MODULE_0___default.a().init();
  ...
  Object(_modules_utilities__WEBPACK_IMPORTED_MODULE_1__["containerToContainerFluid"])("#contact-map-wrap"); // containerToContainerFluid on resize event

  window.onresize = function () {
    Object(_modules_utilities__WEBPACK_IMPORTED_MODULE_1__["containerToContainerFluid"])("#contact-map-wrap");
  };
});
...
__webpack_require__(/*! jquery-colorbox */ "./node_modules/jquery-colorbox/jquery.colorbox.js"); // testimonials popup form
